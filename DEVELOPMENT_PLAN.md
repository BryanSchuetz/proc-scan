...
Status: merged dgMarket/MCCDGMarket adapter implemented; deployed Browser Run access probe pending
...
| 4 | dgMarket | [Advanced search](https://www2.dgmarket.com/advanced-search) | Browser-backed adapter is enabled for MCC and MCA notices from the general dgMarket search and [MCCDGMarket](https://mcc.dgmarket.com/). It merges exact notice-ID overlaps before applying the $500,000 USD floor, preserving the general portal's structured fields and the MCC portal's public descriptions. Permission for systematic access has been confirmed. Migration `0020` moves the adapter to Browser Run and adds the MCC channel; deployed-origin acceptance remains to be verified. |
