...
Status: SIMAP and revised dgMarket public adapters enabled
...
| 4 | dgMarket | [Advanced search](https://www2.dgmarket.com/advanced-search) | Direct-HTML adapter is enabled for MCC and MCA Consultancy notices. It uses the MCC funding-agency filter, verifies the buyer identifies MCC or an MCA, and applies a $500,000 USD floor. It uses session pagination, a 90-day initial window, and a two-day cursor overlap. Permission for systematic access has been confirmed. Migration `0019` archives the discontinued EU-scope records under a disabled Source and re-enables the revised adapter. |
