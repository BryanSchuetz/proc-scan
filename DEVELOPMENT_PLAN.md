...
Status: EU Funding & Tenders and Addressability v8 deployed; latest SAM.gov scan quota-limited
...
| TBD | dgMarket | [Buyer list](https://www.dgmarket.com/tenders/buyerList.do) | Blocked pending approved Client scope and Minimum Value Floor; then confirm permitted access, search scope, pagination, and whether a feed/API is available. |
